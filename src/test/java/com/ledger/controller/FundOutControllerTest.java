...
public class FundOutControllerTest {
	@Autowired
	FundOutController fundOutController;
	...
	public void testValidateRequestBody_EmptyRequest() throws Exception {
		String json = "{}";
		mockMvc.perform(MockMvcRequestBuilders.post("/api/fundOut")
				.content(json)
	...
	public void testOK() throws Exception {
		...
		.andExpect(MockMvcResultMatchers.jsonPath("$.message", Is.is("Fund out is processing in async mode!")))
		.andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON));
	}
}
